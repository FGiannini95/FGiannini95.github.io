export const dataTrabajos = [
  {
    ...
    description: "Una silla inspirada en un diseño de Lina Bo Bardi. Los tres planos que componen el asiento recuerdan a los bancos que diseñó la arquitecta para la capilla Santa María dos Anjos, en Sao Paulo. El asiento y el respaldo pueden fabricarse con tableros de fibra o con madera maciza.",
  ...
  },
  {
    ...
    description: "Una estantería que se fija en la estructura arquitectónica para resolver los encuentros de la forma más honesta. Cuyas baldas cambian de sección según la luz que haya entre sus apoyos. Los travesaños donde apoyan las baldas varían en altura para compensar el espesor del tablero. Se construye con madera maciza y tablero de MDF.",
    material: "Madera maciza de pino y MDF hidrófugo.",
